...
export const algorithms = [
  ...
  {
    id: 'shell', name: 'Shell Sort', fn: shellSort, pseudocode: shellPC,
    info: {
  ...
  {
    id: 'cocktail', name: 'Cocktail Sort', fn: cocktailSort, pseudocode: cocktailPC,
    info: {
      best: 'O(n)', average: 'O(n²)', worst: 'O(n²)', space: 'O(1)',
      stable: true, inPlace: true,
      worstCompares: nSquaredOverTwo, worstLabel: 'n(n−1)/2',
  ...
  {
    id: 'counting', name: 'Counting Sort', fn: countingSort, pseudocode: countingPC,
    info: {
  ...
  {
    id: 'radix', name: 'Radix Sort', fn: radixSort, pseudocode: radixPC,
    info: {
